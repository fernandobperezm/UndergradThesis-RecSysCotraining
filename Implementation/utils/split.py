...
Description: This file contains the definition and implementation of a holdout
             and k-fold cross-validation partitioning schemas for training and testing.
