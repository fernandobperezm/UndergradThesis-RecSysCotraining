...
cd run-examples/MyMediaLite/bin/ ; sh holdout-cotraining-knn-slimbpr.sh -p $PPOSITIVES -n $NNEGATIVES; cd ..
...
cd run-examples/ ; sh holdout-cotraining-knn-slim.sh -p $PPOSITIVES -n $NNEGATIVES; cd ..
