...
python3 ../scripts/holdout-cotraining.py \
    ...
    --results_path ../Results/cotraining-mf-holdout.txt \
    --holdout_perc 0.8 \
    --header 0 --sep , \
    ...
    --number_negatives 3 \
    --number_unlabeled 75 \
    --params_1 num_factors=20,lrate=0.01,reg=0.0 \
    --params_2 num_factors=20,lrate=0.01,reg=0.015,iters=10
...
# python3 ../scripts/holdout-cotraining.py \
#     ../Datasets/ml100k/ratings.csv \
#     --results_path ../Results/cotraining-mf.txt \
